...
class U2NET(nn.Module):
    ...
    def __init__(self,in_ch=3,out_ch=1):
        ...
        self.stage3d = RSU5(1280,64,384)
        self.stage2_2d = RSU6(640,64,192)
        self.stage2d = RSU6(448,64,192)
        self.stage1d = RSU7(448,64,96)
        self.stage0_1d = RSU8(224,64,64)
        self.stage0d = RSU9(128,32,32)

        self.side0 = nn.Conv2d(32,out_ch,3,padding=1)
        self.side0_1 = nn.Conv2d(64,out_ch,3,padding=1)
        self.side1 = nn.Conv2d(96,out_ch,3,padding=1)
        self.side2 = nn.Conv2d(192,out_ch,3,padding=1)
        ...
        self.outconv = nn.Conv2d(9,out_ch,1)
    ...
    def forward(self,x):
        ...
        hx3d = self.stage3d(torch.cat((hx4_2dup,hx3),1))
        # print('hx3d size is: ', hx3d.size())
        hx3dup = _upsample_like(hx3d,hx2_2)
        ...
        hx2d = self.stage2d(torch.cat((hx2_2dup,hx2),1))
        ...
        d0_ = self.outconv(torch.cat((d0,d0_1,d1,d2,d3,d4,d4_2,d5,d6),1))
        # print('d0 size is: ', d0_.size())

        return F.sigmoid(d0_), F.sigmoid(d0_1), F.sigmoid(d0), F.sigmoid(d1), F.sigmoid(d2), F.sigmoid(d3), F.sigmoid(d4), F.sigmoid(d4_2), F.sigmoid(d5), F.sigmoid(d6)
