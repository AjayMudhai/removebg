...
class U2NET(nn.Module):
    ...
    def __init__(self,in_ch=3,out_ch=1):
        ...
        self.stage0_1 = RSU8(in_ch,32,128)
    ...
    def forward(self,x):
        ...
        d0_ = self.outconv(torch.cat((d0_1,d1,d2,d3,d5),1))
        # print('d0 size is: ', d0_.size())

        return F.sigmoid(d0_), F.sigmoid(d0_1), F.sigmoid(d1), F.sigmoid(d2), F.sigmoid(d3),F.sigmoid(d5)
